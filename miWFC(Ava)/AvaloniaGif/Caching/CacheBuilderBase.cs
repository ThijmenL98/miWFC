...
internal class CacheBuilderBase<TB> where TB : CacheBuilderBase<TB> {
    ...
    /// <returns></returns>
    public TB WithExpiration(TimeSpan? expiration) {
        Expiration = expiration;
        return (TB) this;
    }

    public TB WithSlidingExpiration() {
    ...
    /// <returns></returns>
    public TB WithBackgroundPurge(TimeSpan? purgeInterval) {
