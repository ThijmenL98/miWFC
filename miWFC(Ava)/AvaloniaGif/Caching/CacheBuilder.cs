...
internal class CacheBuilder<TK, TV> : CacheBuilderBase<CacheBuilder<TK, TV>> {
    internal Func<TK, TV> LoaderFn { get; private set; }
    ...
    public CacheBuilder<TK, TV> WithLoader(Func<TK, TV> loaderFn) {
        LoaderFn = loaderFn;
        return this;
    }
    ...
    /// <returns>the builder</returns>
    public CacheBuilder<TK, TV> WithInitialCapacity(int? initialCapacity) {
    ...
    /// <returns>the builder</returns>
    public CacheBuilder<TK, TV> WithMaximumEntries(int? maximumEntries) {
    ...
    public ICache<TK, TV> Build() {
        return new CacheImpl<TK, TV>(this);
    }
}