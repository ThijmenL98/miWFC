...
public class GridTopology : ITopology {
    ...
    /// </summary>
    public GridTopology(DirectionSet directions, int width, int height, bool periodicX, bool periodicY,
        bool[] mask = null)
    ...
    /// </summary>
    public GridTopology(DirectionSet directions, int width, int height, int depth, bool periodicX, bool periodicY,
        bool periodicZ, bool[] mask = null) {
